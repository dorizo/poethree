            ...
            <div class="sidebar-area inner-right-padding shop-sidebar-area">
              ...
              <div class="widget">
                <div class="widget-banner">
                    <a href="blog.html"><img src="<?=base_url("template")?>/assets/img/photos/banner1.jpg" alt="Image"></a>
                  </div>              
              </div>
              <div class="widget">
                  ...
                  <div class="row row-cols-3 row-gutter-4">
                    <div class="col">
                      <div class="gallery-item">
                        <img src="<?=base_url("template")?>/assets/img/photos/gallery1.jpg" alt="Givest-HasTech">
                        <a class="icon" href="#/"><i class="icofont-instagram"></i></a>
                      </div>
                    </div>
                    <div class="col">
                      <div class="gallery-item">
                        <img src="<?=base_url("template")?>/assets/img/photos/gallery2.jpg" alt="Givest-HasTech">
                        <a class="icon" href="#/"><i class="icofont-instagram"></i></a>
                      </div>
                    </div>
                    <div class="col">
                      <div class="gallery-item">
                        <img src="<?=base_url("template")?>/assets/img/photos/gallery3.jpg" alt="Givest-HasTech">
                        <a class="icon" href="#/"><i class="icofont-instagram"></i></a>
                      </div>
                    </div>
                    <div class="col">
                      <div class="gallery-item">
                        <img src="<?=base_url("template")?>/assets/img/photos/gallery4.jpg" alt="Givest-HasTech">
                        <a class="icon" href="#/"><i class="icofont-instagram"></i></a>
                      </div>
                    </div>
                    <div class="col">
                      <div class="gallery-item">
                        <img src="<?=base_url("template")?>/assets/img/photos/gallery5.jpg" alt="Givest-HasTech">
                        <a class="icon" href="#/"><i class="icofont-instagram"></i></a>
                      </div>
                    </div>
                    <div class="col">
                      <div class="gallery-item">
                        <img src="<?=base_url("template")?>/assets/img/photos/gallery6.jpg" alt="Givest-HasTech">
                        <a class="icon" href="#/"><i class="icofont-instagram"></i></a>
                      </div>
                    </div>
                  </div>
                      ...
                      <div class="product-item">
                        ...
                        <div class="product-info info-style2">
                          <div class="content-inner">                  
                            <h4 class="title"><a href="shop-single-product.html"><?php print_r($galeri["judul_galeri"]);?></a></h4>
                            <div class="prices">
                  ...
                  <div class="row">
                    <div class="col-12 product-items-list">
                      ...
                      <div class="product-item ">
                        <div class="product-thumb">
                          <a href="shop-single-product.html">
                            <img src="<?=base_url("template")?>/assets/img/shop/list1.jpg" alt="Moren-Shop">
                            <span class="thumb-overlay"></span>
                          </a>
                      ...
                      <div class="product-item ">
                        <div class="product-thumb">
                          <a href="shop-single-product.html">
                            <img src="<?=base_url("template")?>/assets/img/shop/list2.jpg" alt="Moren-Shop">
                            <span class="thumb-overlay"></span>
                          </a>
                          <div class="product-action">
                            <a class="action-quick-view ht-tooltip" data-tippy-content="Quick View" href="javascript:void(0);" title="Wishlist">
                      ...
                      <div class="product-item ">
                        <div class="product-thumb">
                          <a href="shop-single-product.html">
                            <img src="<?=base_url("template")?>/assets/img/shop/list3.jpg" alt="Moren-Shop">
                            <span class="thumb-overlay"></span>
                          </a>
                          <div class="product-action">
                            <a class="action-quick-view ht-tooltip" data-tippy-content="Quick View" href="javascript:void(0);" title="Wishlist">
                      ...
                      <div class="product-item ">
                        <div class="product-thumb">
                          <a href="shop-single-product.html">
                            <img src="<?=base_url("template")?>/assets/img/shop/list4.jpg" alt="Moren-Shop">
                            <span class="thumb-overlay"></span>
                          </a>
                          <div class="product-action">
                            <a class="action-quick-view ht-tooltip" data-tippy-content="Quick View" href="javascript:void(0);" title="Wishlist">
                      ...
                      <div class="product-item ">
                        <div class="product-thumb">
                          <a href="shop-single-product.html">
                            <img src="<?=base_url("template")?>/assets/img/shop/list5.jpg" alt="Moren-Shop">
                            <span class="thumb-overlay"></span>
                          </a>
                          <div class="product-action">
                            <a class="action-quick-view ht-tooltip" data-tippy-content="Quick View" href="javascript:void(0);" title="Wishlist">
              ...
              <div class="pagination-area">
                <nav>
                  <ul class="page-numbers">
                    ...
                    <li>
                      <a class="page-number" href="shop.html">4</a>
                    </li>
                    <li>
                      <a class="page-numbe" href="shop.html">…</a>
                    </li>
                    <li>
                      <a class="page-number" href="shop.html">6</a>
                    </li>
                    <li>
                      <a class="page-number" href="shop.html">7</a>
                    </li>
                    <li>
                      <a class="page-number" href="shop.html">8</a>
                    </li>
                    <li>
